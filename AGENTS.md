...
- **Version:** 1.0.0 (versionCode 15 — historical sequence v3 → v7 (2026-05-21, full {RO-12 + R3-01 through R3-04} bundle) → v9 (2026-05-23, Plan R4 Wave 1 bundle, smoke test PASSED) → v10 (2026-05-24, R4-07 boss-drop PS) → v11 (2026-05-24, Plan R4 complete + Quick Invest FAB removal, uploaded to closed track) → v12 (2026-05-25, #18 ad-rewarded card pack persistence fix) → v13 (2026-05-25 evening, #19 + #20 fix bundle, built+signed but rejected by Play Console as "versionCode already used" — likely an aborted/cached upload registration; not on any track) → v14 (2026-05-26 early hours, same #19 + #20 fix bundle as v13, versionCode bumped 13 → 14 in commit `8b51cc5`, AAB v14 built+signed 2026-05-26 02:08 BST, uploaded + smoke test PASSED 2026-05-26 ~05:35 BST) → **v15 (2026-05-27, v14-soak-board hotfix bundle: PR #56 #53 card upgrade descriptions + PR #57 #55 lab mission credit + PR #58 #54 orbs do no damage. versionCode bumped 14 → 15. AAB built+signed 2026-05-27 ~05:36 BST. Uploaded to closed track 2026-05-27 ~05:39 BST; on-device smoke test pending).**
...
- [ ] **Plan 31: Play Console & Store Publication** *(in closed-track soak — Phases A–G complete; AAB v14 smoke test PASSED 2026-05-26 ~05:35 BST. Three real-bug issues subsequently filed during v14 soak (#53 / #54 / #55) all fixed and merged 2026-05-27 via PRs #56 / #58 / #57. **AAB v15 (versionCode 15) bundling all 3 fixes uploaded to closed track 2026-05-27 ~05:39 BST; on-device smoke test pending.** Closed-track ≥14-day window resumes from v14 effective 2026-05-26 — uploading v15 mid-window does NOT reset the 14-day clock as long as v15 doesn't surface fresh blockers, so earliest production-access application stays 2026-06-09. **Active gating activity is tester recruitment + soak.** Closed-track ≥14-day / ≥12-tester gate then production access application + Google review (1–3 days) + staged rollout + tag v1.0.0.)*
- [ ] **Plan V1X: v1.x Roadmap** *(planning complete, execution begins post-launch — 29 sub-plans across 6 versioned releases (v1.0.1 polish → v1.0.2 audio → v1.1 testing-infra + simulation extraction → v1.2 cloud save + i18n) authored 2026-05-26 in `docs/plans/plan-V1X-roadmap.md` (~1300 lines). 4 user decisions locked: #43 CELESTIAL_GATE deferred (V1X-15), #44 ENEMY_INTEL designed (V1X-15b: +2 %/lvl dmg + tiered UI overlays), #40 GPS dropped from GDD (ADR-0016), #49 STEP_MULTIPLIER asymptotic curve coordinated with RO-09 #3 (ADR-0015). 7 new ADRs queued (ADR-0011 through ADR-0017). 1 schema migration expected (v11→v12 in V1X-12 cloud save). Test count target 656 → ~910 (≃40 instrumented + ~210 JVM net). Wave 1 (V1X-01 in-app data deletion + V1X-02 Season Pass UI + V1X-03 per-screen nav icons, ~2 days) is the first scheduled implementation work post-v1.0.0 production rollout.)*
