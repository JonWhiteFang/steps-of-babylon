...
- **Version:** 1.0.0 (versionCode 9 — historical sequence v3 (2026-05-15) → v7 (2026-05-21, full {RO-12 + R3-01 through R3-04} bundle, on-device PASSED) → v8 (2026-05-23, built but discarded after R4-02b user amendment) → **v9 (2026-05-23, Plan R4 Wave 1 bundle: R4-01 remove Step Overdrive + R4-02 Multishot/Bounce per-level scaling + R4-02b Labs research path + R4-04 Material upgrade icon, 627 → 616 tests, versionCode 8 → 9 in commit `cbbb525`, uploaded to Play Console internal track 2026-05-23, on-device smoke test PASSED 2026-05-23)**. Plan R4 Wave 2 next (R4-03 Rapid Fire + R4-06 UW auto-trigger / 3-path upgrades + R4-07 boss-drop Power Stones; combined Room migration v9→v10; 2 new ADRs); Wave 3 (R4-08 cards rewrite, schema v10→v11) and Wave 4 (R4-05 Help screen) close out R4 before closed-track promotion.)
