...
- [ ] **Plan 31: Play Console & Store Publication** *(in closed-track soak — Phases A–G complete; AAB v14 smoke test PASSED 2026-05-26 ~05:35 BST. Three real-bug issues subsequently filed during v14 soak (#53 / #54 / #55) all fixed and merged 2026-05-27 via PRs #56 / #58 / #57. AAB v15 (versionCode 15) built+signed 2026-05-27 ~05:36 BST bundling all 3 fixes; ready for closed-track upload. Closed-track ≥14-day window resumes from v14 effective 2026-05-26 — uploading v15 mid-window does NOT reset the 14-day clock as long as v15 doesn't surface fresh blockers, so earliest production-access application stays 2026-06-09. **Active gating activity is tester recruitment + soak.** Closed-track ≥14-day / ≥12-tester gate then production access application + Google review (1–3 days) + staged rollout + tag v1.0.0.)*
