...
- [ ] **Plan V1X: v1.x Roadmap** *(execution in progress — 16 sub-plans merged to `main` 2026-05-28 across PRs #64–#79; V1X-08 instrumented tests completed 2026-05-29 across PRs #80–#83 (`BattleSurfaceLifecycleTest` + `DeepLinkIntentTest` shipped, `StoreIapFlowTest` formally deferred), and V1X-15b ENEMY_INTEL combat foundation merged via PR #84. Wave 1 complete (V1X-01/02/03), Wave 2 complete (V1X-04/05/06), Wave 3 partial (V1X-07/08/09/10/11), content/balance/docs partial (V1X-14/15/15b-combat/16/17/18/19). 4 ADRs added: ADR-0012 simulation extraction, ADR-0015 STEP_MULTIPLIER asymptotic curve, ADR-0016 GPS reconciliation, ADR-0017 ENEMY_INTEL design. Test count 656 → 806 (+150 JVM) + 9 instrumented. Remaining substantial items: V1X-15b ENEMY_INTEL UI overlays (combat foundation shipped; L1/L5/L10 overlays need on-device verification), V1X-09 Phase 2/3 entity extraction, V1X-12 cloud save (schema v11→v12), V1X-13 i18n.)*
