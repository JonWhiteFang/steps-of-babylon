...
- Instrumented tests live under `app/src/androidTest/java/com/whitefang/stepsofbabylon/`. Harness landed in V1X-08 Phase 1A (1 smoke test); follow-up PRs add `BattleSurfaceLifecycleTest`, `StoreIapFlowTest`, `DeepLinkIntentTest`.
