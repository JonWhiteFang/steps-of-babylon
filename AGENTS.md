...
- [ ] **Plan 31: Play Console & Store Publication** *(in closed-track soak — Phases A–G complete; AAB v14 (versionCode 14) **on-device smoke test PASSED 2026-05-26 ~05:35 BST** on an upgrade-from-v8 device confirming the #19 + #20 fix bundle works end-to-end (Golden Tower UW auto-triggers, RAPID_FIRE visible in Workshop, MULTISHOT_RESEARCH + BOUNCE_RESEARCH visible in Labs). Closed-track ≥14-day window resumes from v14 effective 2026-05-26; earliest production-access application 2026-06-09. **Active gating activity has shifted from on-device verification to tester recruitment + soak.** Closed-track ≥14-day / ≥12-tester gate then production access application + Google review (1–3 days) + staged rollout + tag v1.0.0.)*
