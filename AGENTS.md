...
- [ ] **Plan V1X: v1.x Roadmap** *(execution in progress — 16 of 29 sub-plans merged to `main` 2026-05-28 across 16 PRs (#64–#79). Wave 1 complete (V1X-01/02/03), Wave 2 complete (V1X-04/05/06), Wave 3 partial (V1X-07/09/10/11), content/balance/docs partial (V1X-14/15/16/17/18/19). 3 ADRs added: ADR-0012 simulation extraction, ADR-0015 STEP_MULTIPLIER asymptotic curve, ADR-0016 GPS reconciliation. Test count 656 → 800 (+144). Remaining substantial items: V1X-08 instrumented tests, V1X-09 Phase 2/3 entity extraction, V1X-12 cloud save (schema v11→v12), V1X-13 i18n, V1X-15b ENEMY_INTEL ship.)*
...
- Instrumented tests live under `app/src/androidTest/java/com/whitefang/stepsofbabylon/`. Harness landed in V1X-08 Phase 1A (1 smoke test); `BattleSurfaceLifecycleTest` (4 tests, R3-01 regression guards) layered on 2026-05-29; follow-up PRs add `StoreIapFlowTest`, `DeepLinkIntentTest`.
