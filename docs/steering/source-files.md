...
data/local/DatabaseKeyManagerTest.kt               # SQLCipher passphrase via Android Keystore: generate-once, persist, recover on keystore mismatch (Robolectric)
