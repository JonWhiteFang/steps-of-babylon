...
- [~] Plan 31: Play Console & Store Publication *(internal track live + on-device-verified, v1.0.11/vc 27; promotion to closed test is judgment-gated on the Closed-Test Readiness Gate, see plan-FORWARD.md. The ≥14-day soak / ≥12-tester clock + production access are Phase 2, beginning AFTER promotion; the production-rollout tag is decided then. Reframed in PR #145.)*
