...
│       ├── engine/     # SimulationMath (pure-math helpers) + Simulation (V1X-09 Phase 3 — pure-domain in-round state: cash economy + round-progress counters + entity tick + collision sweep; GameEngine delegates that surface + hasWaveProgress)
