    ...
    private fun spawnParticles() {
        when (type) {
            ...
            UltimateWeaponType.CHAIN_LIGHTNING -> {
                repeat(4) {
                    val p = pool.acquire()
                    p.x = cx + Random.nextFloat() * 100f - 50f
                    p.y = cy + Random.nextFloat() * 100f - 50f
                    p.vx = Random.nextFloat() * 200f - 100f
                    p.vy = Random.nextFloat() * 200f - 100f
                    p.color = 0xFFE0E0FF.toInt()
                    p.size = 3f
                    p.lifetime = 0.15f
                }
            }
            ...
            UltimateWeaponType.BLACK_HOLE -> {
                ...
                p.vx = -cos(angle) * 60f
                p.vy = -sin(angle) * 60f
                p.color = 0xFF6A0DAD.toInt()
                p.size = 3f + Random.nextFloat() * 2f
                p.lifetime = 0.5f
            }
            ...
            UltimateWeaponType.POISON_SWAMP -> {
                val p = pool.acquire()
                p.x = cx + Random.nextFloat() * 160f - 80f
                p.y = cy + Random.nextFloat() * 20f
                p.vx = Random.nextFloat() * 10f - 5f
                p.vy = -20f - Random.nextFloat() * 30f
            ...
            UltimateWeaponType.GOLDEN_ZIGGURAT -> {
                val p = pool.acquire()
                p.x = cx + Random.nextFloat() * 120f - 60f
                p.y = cy - 60f - Random.nextFloat() * 40f
                p.vx = Random.nextFloat() * 20f - 10f
                p.vy = 30f + Random.nextFloat() * 20f
                p.color = 0xFFFFD700.toInt()
