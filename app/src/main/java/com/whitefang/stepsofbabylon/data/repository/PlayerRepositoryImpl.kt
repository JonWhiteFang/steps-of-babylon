...
class PlayerRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun spendGems(amount: Long): Boolean = dao.spendGemsAtomic(amount) > 0
        ...
        override suspend fun incrementBattleStats(
            ...
            kills: Long,
            cash: Long,
        ) = dao.incrementBattleStats(rounds, kills, cash)
        ...
        override suspend fun updateSeasonPass(
            active: Boolean,
            expiry: Long,
        ) = dao.updateSeasonPass(active, expiry)
        ...
        override suspend fun getStepBalance(): Long = dao.get().first()?.currentStepBalance ?: 0
        ...
        private fun PlayerProfileEntity.toDomain() =
            PlayerProfile(
                id = id,
