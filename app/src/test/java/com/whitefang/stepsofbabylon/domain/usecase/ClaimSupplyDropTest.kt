...
class ClaimSupplyDropTest {
    ...
    @Test
    fun `claiming steps drop adds steps to player`() =
        runTest {
    ...
    @Test
    fun `claiming gems drop adds gems to player`() =
        runTest {
            playerRepo.ensureProfileExists()
    ...
    @Test
    fun `claiming power stones drop adds power stones`() =
        runTest {
            playerRepo.ensureProfileExists()
    ...
    @Test
    fun `claiming card copy drop adds card to inventory`() =
        runTest {
            playerRepo.ensureProfileExists()
    ...
    @Test
    fun `claiming marks drop as claimed`() =
        runTest {
            playerRepo.ensureProfileExists()
    ...
    @Test
    fun `claiming already claimed drop returns AlreadyClaimed`() =
        runTest {
    ...
    @Test
    fun `R122 double-claim credits the reward exactly once`() =
        runTest {
            playerRepo.ensureProfileExists()
