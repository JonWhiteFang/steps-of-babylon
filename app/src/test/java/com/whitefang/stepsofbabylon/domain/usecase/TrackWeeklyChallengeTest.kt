...
class TrackWeeklyChallengeTest {
    ...
    @Test
    fun `awards delta 10 PS at 75k after 50k claimed`() =
        runTest {
            seedSteps(55_000)
            useCase.checkAndAward()
            assertEquals(10, playerRepo.profile.value.powerStones)
    ...
    @Test
    fun `awards delta 15 PS at 100k after 75k claimed`() =
        runTest {
            seedSteps(80_000)
    ...
    @Test
    fun `no double award for same tier`() =
        runTest {
            seedSteps(55_000)
            useCase.checkAndAward()
            useCase.checkAndAward()
