...
class GenerateDailyMissionsTest {
    ...
    @Test
    fun `generates exactly 3 missions`() =
        runTest {
            useCase("2026-03-09")
    ...
    @Test
    fun `same date generates same missions (deterministic)`() =
        runTest {
            useCase("2026-03-09")
    ...
    @Test
    fun `different dates can generate different missions`() =
        runTest {
            useCase("2026-03-09")
    ...
    @Test
    fun `does not regenerate if missions already exist`() =
        runTest {
            useCase("2026-03-09")
    ...
    @Test
    fun `missions start with zero progress and unclaimed`() =
        runTest {
            useCase("2026-03-09")
            val missions = dao.dao.getByDateOnce("2026-03-09")
            missions.forEach { m ->
